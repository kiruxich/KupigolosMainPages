...
Дашборд и пять дополнительных страниц вынесены в отдельные репозитории и проекты Vercel. Текущий сайт доступен по адресу [kupigolos.vercel.app](https://kupigolos.vercel.app).
