...
- `/` — главная страница КупиГолос;
- `/six-pages` — заготовка следующего блока страниц;
- `/diktory` и `/perevod` — SEO-страницы каталога и локализации.

Дашборд рабочих проектов вынесен в отдельный репозиторий и проект Vercel. Текущий сайт доступен по адресу [kupigolos.vercel.app](https://kupigolos.vercel.app).
